...
const email_password = async (req, res) => {
    ...
    const url = `http://daniel201255.hopto.org/Reset_pass?${token}&email=${email}`
    console.log(email)
    await transporter.sendMail({
        from: '"" <201255@ids.upchiapas.edu.mx>', // sender address
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                                    ...
                                                    Si no realizó esta solicitud, simplemente ignore este correo electrónico. De lo contrario, haga clic en el botón de arriba para restablecer su contraseña.
                                                    </div>
